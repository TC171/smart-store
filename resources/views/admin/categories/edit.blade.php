    ...
    <form action="{{ route('admin.categories.update', $category->id) }}"
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                class="w-full bg-gray-800 text-white border border-gray-700 
                       rounded-lg px-4 py-2 focus:ring-2 focus:ring-cyan-500">{{ old('description', $category->description) }}</textarea>
            @error('description')
            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="border-t border-gray-700 pt-6">
            ...
            <div class="mt-4">
                ...
                <textarea name="meta_description" rows="3"
                    class="w-full bg-gray-800 text-white border border-gray-700 
                           rounded-lg px-4 py-2 focus:ring-2 focus:ring-cyan-500">{{ old('meta_description', $category->meta_description) }}</textarea>
            ...
            <div class="mt-4">
                ...
                <textarea name="meta_keywords" rows="3"
                    class="w-full bg-gray-800 text-white border border-gray-700 
                           rounded-lg px-4 py-2 focus:ring-2 focus:ring-cyan-500">{{ old('meta_keywords', $category->meta_keywords) }}</textarea>
                @error('meta_keywords')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
