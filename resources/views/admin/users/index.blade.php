...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-white">Danh sách Tài khoản</h1>
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-800 hover:bg-gray-800 transition">
                    ...
                    <td class="px-6 py-4">
                        ...
                        @endphp
                        <span class="inline-block px-3 py-1 rounded-full text-xs font-semibold {{ $roleColors[$user->role] ?? 'bg-gray-500/20 text-gray-400' }}">
    ...
    <div class="text-center py-12 bg-gray-900 rounded-xl">
        <p class="text-gray-400 text-lg">Chưa có tài khoản nào</p>
    </div>
    @endif
